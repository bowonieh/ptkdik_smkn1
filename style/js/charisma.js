$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','../style/css/bootstrap-'+theme_name+'.css');
	}
...
$(document).on('#formInput','submit',function(){
...
$(document).ready(function() {
$('.alert').hide();
$(".tambahguru").click(function(event){
     //alert("Hapus?");
...
$(document).ready(function() {
$('#editform').hide();
$("#editprofil").click(function(event){
    //$('#editform').hide();
    $('#detilprofil').fadeOut('fast');
    $('#editform').delay(100).fadeIn('slow');
    event.preventDefault();
    });
    
$('#canceledit').click(function(event){
    $('#editform').fadeOut('fast');
    $('#detilprofil').delay(100).fadeIn('slow');
    event.preventDefault();
    });
});